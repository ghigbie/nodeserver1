...
var Vehicle = require('./app/modles/vehicle');

//Confiure app for bodyPArser()
...
//MIDDLEWARE
//Middleware can be very useful for doing validataions
//We can log things from here or stop things from continuing
...
router.route('/vehicles')
  ...
  .post(function(req, res){
    ...
    vehicle.save(function(err){
      ...
      res.json({message: 'Vehicle was sucessfull manufactured')
    });
  })
  ...
  router.route('/vehicle/:vehicle_id')
    .get(function(req, res){
      Vehicle.findById(req.params.vehcle_id, function(err, vehicle){
        if(err){
          res.send(err);
        }
        res.json(vehicles);
